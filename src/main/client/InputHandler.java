...
public final class InputHandler
{
    ...
    protected static void update()
    {
        ...
        if (grabCursor)
            glfwSetCursorPos(window, Window.getWidth() / 2, Window.getHeight() / 2);
    }
    ...
    public static Vector2f cursorPosition()
    {
        ...
        return Vector2f.sub(new Vector2f((float) x.get(0), (float) y.get(0)), new Vector2f(Window.getWidth() / 2, Window.getHeight() / 2), null);
    }
